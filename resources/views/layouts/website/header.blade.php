            ...
            <div class="header-top">
                <div class="header-profile">
                    @if (Auth::guard('web')->check())
                        <a href="{{ route('website.profile') }}"><span>{{ auth('web')->user()->name }}</span></a>
                    @endif
                    <a href="order.html"><span>{{ __('website.order_track') }}</span></a>
                    <a href="{{ route('website.faqs.index') }}"><span>{{ __('website.support') }}</span></a>
                </div>
                <div class="header-contact d-none d-lg-block">
                    <a href="#">
                        <span>{{ __('website.need_help') }}</span>
                                        ...
                                        <div class="dropdown-item d-flex justify-content-between align-items-center">
                                            <div class="dropdown-list-item d-flex">
                                                <span class="dropdown-img">
                                                    <img src="{{ asset($item->icon) }}" alt="baby">
                                                </span>
        ...
        <div class="container">
            <div class="header-nav">
                    ...
                    <ul class="menu-list">
                        ...
                        <li>
                            <a href="{{ route('website.home') }}">
                                <span class="list-text">{{ __('website.home') }}</span>
                            </a>
                        </li>
                        {{-- shop --}}
                        <li class="mega-menu">
                            ...
                            <div class="shop-menu">
                                @if ($categories_children->count() > 0)
                                    <div class="menu-wrapper">
                                        @foreach ($categories_children as $item)
                                            <div class="menu-list">
                                                <a href="{{ route('website.categories.products',$item->slug) }}"> <h5 class="menu-title">{{ $item->name }}</h5></a>
                                                <ul>
                                                    @foreach ($item->children as $child)
                                                        <li><a href="{{ route('website.categories.products',$child->slug) }}">{{ $child->name }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                            ...
                            <ul class="header-sub-menu">
                                @if ($pages->count() > 0)
                                    @foreach ($pages as $item)
                                        <li><a
                                                href="{{ route('website.dynamic.page', $item->slug) }}">{{ $item->title }}</a>
                                        </li>
                                    @endforeach
                                @endif
                        ...
                        @if (auth('web')->check())
                            <li>
                                <a href="{{ route('website.profile') }}">
                                    <span class="list-text">{{ __('website.user_dashboard') }}</span>
                                </a>
                            </li>
                        @endif
                        <li>
                ...
                <div class="header-vendor-btn">
                    @if (app()->getLocale() == 'ar')
                        <a rel="alternate" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}"
                            class="shop-btn">
                            <span class="list-text shop-text">{{ __('website.english') }}</span>
                            <span class="icon">
                    ...
                    @else
                        <a rel="alternate" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}"
                            class="shop-btn">
                            <span class="list-text shop-text">{{ __('website.arabic') }}</span>
                            <span class="icon">
                                <svg width="24" height="16" viewBox="0 0 24 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
