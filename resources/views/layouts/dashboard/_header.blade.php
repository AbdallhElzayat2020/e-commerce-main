                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i
                            ...
                            <span id="notification_count"
                                class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">{{ auth('admin')->user()->unreadNotifications->count() }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span id="notification_count_inside"
                                    class="notification-tag badge badge-default badge-danger float-right m-0">{{ auth('admin')->user()->unreadNotifications->count() }}
                                </span>
                            </li>
                            <li id="pushRealTime" class="scrollable-container media-list w-100">
                                @php
                                ...
                                @forelse ($notifications as $notification)
                                    @if ($notification->type === 'CreateOrderNotification')
                                        <a
                                            href="{{ route('dashboard.orders.show', $notification->data['order_id']) }}?notify_admin={{ $notification->id }}">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="notification-text font-small-3 text-muted">
                                                        ...
                                                        EGP {{ $notification->data['total_price'] }}
                                                    </p>
                                                    <small>
