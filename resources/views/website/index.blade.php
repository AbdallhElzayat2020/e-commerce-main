                    ...
                    <div class="col-lg-6">
                        <div class="wrapper-section" data-aos="fade-up">
                            <div class="wrapper-info">
                                ...
                                <h1 class="wrapper-details">{{ $item->note }}</h1>
                                <a href="{{ route('website.shop') }}" class="shop-btn">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-one" data-aos="fade-right">
                            <div class="wrapper-info">
                                ...
                                <a href="{{ route('website.shop') }}" class="shop-btn">Shop Now
                                    <span>
            ...
            <div class="flash-sale-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                            <div class="product-img">
                                <img src="{{ asset('uploads/products/'.$item->images->first()->file_name) }}" alt="{{ $item->name }}">
                                <div
                                class="position-absolute top-0 start-0 bg-danger text-white py-1 px-2 m-2 rounded">
                                {{ $item->brand->name }}
                                </div>
