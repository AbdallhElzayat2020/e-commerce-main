  ...
  <section class="blog about-blog">
      <div class="container">
        <div class="blog-bradcrum">
          ...
          <span><a href="javascript:void(0)">{{ __('website.contact') }}</a></span>
        </div>
        <div class="blog-heading about-heading">
          <h1 class="heading">{{ __('website.contact') }}</h1>
        </div>
      </div>
    </section>
            ...
            <div class="col-lg-6">
              <div class="contact-info-section">
                <div class="contact-information">
                  <h5 class="wrapper-heading">{{__('website.contact_information')}}</h5>
                  <p class="paragraph">
                      ...
                      <div class="col-sm-6">
                        <div class="wrapper phone">
                          ...
                          <div class="wrapper-content">
                            <h5 class="wrapper-heading">{{__('website.phone')}}</h5>
                            <p class="paragraph">+{{ $setting->site_phone}}</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="wrapper phone">
                          ...
                          <div class="wrapper-content">
                            <h5 class="wrapper-heading">{{ __('website.email') }}</h5>
                            <p class="paragraph">
                              <a
